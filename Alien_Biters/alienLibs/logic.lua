...
-- Alien.lords[biter.unit_number] = nil
-- otherwise if lords is just an array of biters
-- for i=1,#Alien.lords do
--    if (Alien.lords[i] == biter) then
--       table.remove(Alien.lords, i)
--       break
--    end
-- end
